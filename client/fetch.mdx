---
title: "Making HTTP requests with the EpoxyClient fetch() API"
sidebarTitle: "Fetch"
description: "Send HTTP requests through a Wisp proxy using EpoxyClient.fetch(), a Fetch API replacement with redirect control and raw header access."
---
